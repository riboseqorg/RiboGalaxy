    ...
    if options.params == 'preSet':
        ...
        try:
            ...
            if options.keepends and options.keepends == 'doKeepends':
                ...
                keepends = ''
            if options.output_unmapped_reads_l or options.output_unmapped_reads_r or options.output_unmapped_reads:
                aligning_cmds = '-q %s %s -p %s %s %s %s %s %s %s %s %s %s %s %s %s ' \
                            '%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s 1> /dev/null' % \
